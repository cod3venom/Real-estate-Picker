...
class Selectors:
    ...
    GALLERY_SELECTED = ctx.Settings.MORIZON_SELECTORS["GALLERY_SELECTED"]
    GALLERY_NEXT = ctx.Settings.MORIZON_SELECTORS["GALLERY_NEXT"]
    GALLERY_CLOSE = ctx.Settings.MORIZON_SELECTORS["GALLERY_CLOSE"]
