...
class Selectors:
    ...
    GALLERY_MAIN = ctx.Settings.DOMIPORTA_SELECTORS["GALLERY_MAIN"]
    SCROLL_TO_GALLERY = ctx.Settings.DOMIPORTA_SELECTORS["SCROLL_TO_GALLERY"]
    GALLERY_SELECTED_IMAGE = ctx.Settings.DOMIPORTA_SELECTORS["GALLERY_SELECTED_IMAGE"]
    GALLERY_NEXT_BUTTON = ctx.Settings.DOMIPORTA_SELECTORS["GALLERY_NEXT_BUTTON"]
    TOTAL_IMAGES = ctx.Settings.DOMIPORTA_SELECTORS["TOTAL_IMAGES"]
