...
class Selectors:
    ...
    OFFER_STATUS = ctx.Settings.OLX_SELECTORS["OFFER_STATUS"]

    OLX_USER_EMAIL_INPUT = ctx.Settings.OLX_SELECTORS["OLX_USER_EMAIL_INPUT"]
    OLX_USER_PASSWORD_INPUT = ctx.Settings.OLX_SELECTORS["OLX_USER_PASSWORD_INPUT"]
    OLX_CAPTCHA_BUTTON = ctx.Settings.OLX_SELECTORS["OLX_CAPTCHA_BUTTON"]
    OLX_LOGIN_BUTTON = ctx.Settings.OLX_SELECTORS["OLX_LOGIN_BUTTON"]