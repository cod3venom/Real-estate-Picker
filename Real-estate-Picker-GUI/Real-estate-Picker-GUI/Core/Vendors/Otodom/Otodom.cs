...
namespace Real_estate_Picker_GUI.Core.Vendors.Otodom
{
    public class Otodom
    {
        private Home parent;
        ...
        public Otodom(Home parent, Context ctx)
        {

            this.parent = parent;
            this.ctx = ctx;
            this.ctx.Nethandler.netMessageHandler.AddMessageHeader(Vendors.Otodom);
            this.page = new CVendorPage(this.ctx);
            this.page.PageName = Vendors.Otodom;
