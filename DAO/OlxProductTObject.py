...
class OlxProductTObject:

    def __init__(self, TITLE: str, DESCRIPTION: str, IMAGES: str, PRICE: str, MEASUREMENT: str,
        ...
        try:
            if jsData != "":
                ...
                return cls(**{'title': 'empty', 'description': 'empty', 'images': 'empty', 'price': 'empty',
                              'measurement': 'empty', 'rooms_amount': 'empty',
    ...
    def __repr__(self):
        ...
        buffer.append("<OlxProductTObject:")
